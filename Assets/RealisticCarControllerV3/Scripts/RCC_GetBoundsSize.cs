...
/// </summary>
public class RCC_GetBoundsSize : MonoBehaviour {
	...
	public static Vector3 GetBoundsCenterVector(Transform obj){
	...
	/// <param name="obj">Object.</param>
	public static float MaxBoundsExtentValue(Transform obj){
